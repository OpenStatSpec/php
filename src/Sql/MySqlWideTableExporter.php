 ...
 * MySQL/MariaDB. V3 extension metadata remains explicitly deferred.
 */
final readonly class MySqlWideTableExporter
{
    ...
    public function export(string $datasetName, string $targetFormat = 'sav'): array
    {
        ...
        return [
            ...
            'diagnostics' => [
                new FidelityDiagnostic('deferred_variable_extensions', 'MySQL/MariaDB export has not yet restored roles, attributes, variable sets, or multiple-response sets.'),
            ],
        ];
    }
